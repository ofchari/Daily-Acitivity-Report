...
class DesigningDailyActivity extends StatefulWidget {
  ...
  @override
  State<DesigningDailyActivity> createState() => _DesigningDailyActivityState();
}

class _DesigningDailyActivityState extends State<DesigningDailyActivity> {
  late double height;
  late double width;
  ...
  // Fixed business type
  final String _businessType = 'Designing';

  // Customer options
  final List<String> _customers = ['Regent', 'info', 'DG', 'GG'];

  // Activity type options
  final List<String> _activityTypes = ['Publication', 'DOp'];

  // Call type options
  final List<String> _callTypes = ['New Product', 'Corrections'];
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4.h),
                        Text(
                          'Track your daily designing activities efficiently',
                          style: GoogleFonts.dmSans(
                            fontSize: 14.sp,
                  ...
                  _buildFormSection(
                    title: 'Designing Activity Details',
                  ...
                  _buildFormSection(
                    title: 'Designing Publication Details',
